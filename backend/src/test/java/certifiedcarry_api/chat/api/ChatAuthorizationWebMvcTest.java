...
class ChatAuthorizationWebMvcTest {
    ...
    private static final OffsetDateTime FIXED_TIMESTAMP = OffsetDateTime.parse("2026-04-03T20:00:00Z");
    ...
    private Map<String, Object> threadRow(String id, String participantUserId1, String participantUserId2) {
        ...
        row.put("lastMessageAt", FIXED_TIMESTAMP);
        row.put("lastMessagePreview", "preview");
        row.put("createdAt", FIXED_TIMESTAMP);
        row.put("updatedAt", FIXED_TIMESTAMP);
        return row;
    }
