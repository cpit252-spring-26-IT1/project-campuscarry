...
final class PlayerProfilePatchRequest {
  ...
  void setRocketLeagueModes(List<String> rocketLeagueModes) { this.rocketLeagueModes = rocketLeagueModes; rocketLeagueModesSet = true; }
...
record PlayerProfileResponse(
  ...
  static PlayerProfileResponse fromServiceRow(Map<String, Object> row) {
    return new PlayerProfileResponse(
        ...
        castStringList(row.get(PlayerProfileFields.ROCKET_LEAGUE_MODES)),
